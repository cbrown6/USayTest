...
import static stepdefs.SharedDriver.runConfig;

public class TestRailAPI {
    private  APIClient client;

//    public static void configureOutputSettings(){
//        Config.testRailProjectID = JOptionPane.showInputDialog("Enter the Project ID");
//        Component frame = null;
//        int reTest = JOptionPane.showConfirmDialog(
//                frame,
//                "Is this a retest?",
//                "TestRail Interface",
//                JOptionPane.YES_NO_OPTION);
//        System.out.print(reTest);
//        if (reTest == YES_OPTION){
//            Config.testRailReTest = true;
//            Config.testRailSuiteID = JOptionPane.showInputDialog("Enter the ID of the Suite");
//            Config.testRailRunID = JOptionPane.showInputDialog("ID of Run to Retest");
//        }
//        else if (reTest == NO_OPTION) {
//            Config.testRailReTest = false;
//            int newSuite = JOptionPane.showConfirmDialog(
//                    frame,
//                    "Do you want to add a new test suite",
//                    "TestRail Interface",
//                    JOptionPane.YES_NO_OPTION);
//            if (newSuite == YES_OPTION){
//                Config.createNewTestSuite = true;
//            }
//            else {
//                Config.createNewTestSuite = false;
//                Config.testRailSuiteID = JOptionPane.showInputDialog("Enter the ID of the Suite to add a run to");
//            }
//        }
//        else {
//            System.exit(0);
...
//    }
    ...
    public  JSONObject newTestCase (String SuiteID, String title) throws Exception {
        ...
        return (JSONObject) client.sendPost("add_case/" + SharedDriver.testSection + "/", Case);
    }

    ...
    public void i_go_to_the_page(String page) throws InterruptedException {
        ...
        switch (page.toUpperCase()){
            case "HOME":
                homePage.goTo();
                break;
            case "REGISTRATION": titlePage.goTo();
                break;
            case "PRODUCT": i_go_to_the_product_page();
                break;
            case "TERMINAL NODE": fail("Terminal Node page is now off");
                break;
            case "CATEGORY": i_go_to_the_category_page();
                break;
